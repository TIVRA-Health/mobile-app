...
import 'package:tivra_health/common/otp_under_line_view/otp_field_style.dart';
import 'package:tivra_health/common/otp_under_line_view/otp_style.dart';
  ...
  Widget buildTextField(BuildContext context, int index) {
    ...
    return Container(
      ...
      child: TextField(
        ...
        style: getTextRegular(size: SizeConstants.s_18, colors: Colors.black),
