...
class AppBars {
  ...
  static PreferredSizeWidget appBarDashboard(
    ValueChanged<String> appbarActionInterface,
    ...
    return PreferredSize(
      ...
      child: AppBar(
        ...
        title: Row(
          ...
          children: [
            SizedBox(
              ...
              child: Image.asset(
                ImageAssets.imageSideMenuTopAppIcon,
        ...
        backgroundColor: ColorConstants.cSideMenu,
      ),
    );
  }
