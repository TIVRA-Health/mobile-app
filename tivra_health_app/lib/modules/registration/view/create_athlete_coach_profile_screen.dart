...
class CreateAthleteCoachProfileScreen extends StatefulWidget {
  final int currentStep;
  final String role;

  const CreateAthleteCoachProfileScreen(this.currentStep,this.role, {Key? key})
      : super(key: key);

  @override
  State<CreateAthleteCoachProfileScreen> createState() => _CreateAthleteCoachProfileScreen();
}

class _CreateAthleteCoachProfileScreen extends State<CreateAthleteCoachProfileScreen> {
  @override
                  ...
                  Row(
                    children: [
                      SizedBox(
                        ...
                        child: Text(
                          AppConstants.mWordConstants.sCorporateAffiliation,
