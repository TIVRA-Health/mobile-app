...
class PlayerFitnessScreenWidget extends StatefulWidget {
  late PlayerDetailsModel mPlayerModel;
  late List<Fitness> fitness;

  PlayerFitnessScreenWidget(
      {super.key, required this.mPlayerModel, required this.fitness});

  @override
  State<PlayerFitnessScreenWidget> createState() =>
      _PlayerFitnessScreenWidgetState();
}

class _PlayerFitnessScreenWidgetState
    extends State<PlayerFitnessScreenWidget> {
  @override
  void initState() {
    print("_PlayerFitnessScreenWidgetState ${jsonEncode(widget.fitness)}");
    super.initState();
  }
