...
class PlayerHealthScreenWidget extends StatefulWidget {
  late PlayerDetailsModel mPlayerModel;
  late List<Health> health;

  PlayerHealthScreenWidget(
      {super.key, required this.mPlayerModel, required this.health});

  @override
  State<PlayerHealthScreenWidget> createState() =>
      _PlayerHealthScreenWidgetState();
}

class _PlayerHealthScreenWidgetState
    extends State<PlayerHealthScreenWidget> {
  @override
  void initState() {
    super.initState();
  }
    ...
    return Container(
        ...
        child: GridView.builder(
          ...
          itemBuilder: (BuildContext context, int index) {
            ...
            //   base64String =  widget.mPlayerModel.getImage(widget.health[index].icon??"");
            // }
            // print("##### $base64String");
            return Card(
                child: Container(
