...
class PlayerFitnessLineChartWidget extends StatefulWidget {
  final PlayerDetailsModel mPlayerModel;
  final String selectedValue;
  final GetDashboardDetailsResponse mGetDashboardDetailsResponse;

  const PlayerFitnessLineChartWidget(
      {Key? key,
        required this.mPlayerModel,
        required this.selectedValue,
        required this.mGetDashboardDetailsResponse})
      : super(key: key);

  @override
  State<PlayerFitnessLineChartWidget> createState() => _PlayerFitnessLineChartWidgetState();
}

class _PlayerFitnessLineChartWidgetState extends State<PlayerFitnessLineChartWidget> {
  ...
  Widget build(BuildContext context) {
    print("PlayerFitnessLineChartWidget===${widget.selectedValue}");
