...
class DashboardModel {
  ...
  DashboardModel(this.mBuildContext);
  ...
  getAllImage() async {
    ...
    if (sAllImage.isNotEmpty) {
      mAllImageResponse =
          AllImageResponse.fromJson(jsonDecode(sAllImage));
    }
    onRefresh();
  }
  ...
  onRefresh() async {
    ...
    initGetDashboardDetails(sUserId);
  }
  ...
  getDashboardDetailsListener(BuildContext context,
      GetDashboardDetailsState state) {
    switch (state.status) {
      ...
      case GetDashboardDetailsStatus.success:
        ...
        print("#####${jsonEncode(state.mGetDashboardDetailsResponse)}");
        loadEnd();
        break;
    }
  }
  ...
  Stream<GetUserDetailsResponse?> get responseStreamUserDetails => responseSubjectUserDetails.stream;
