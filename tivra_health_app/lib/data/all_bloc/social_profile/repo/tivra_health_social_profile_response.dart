/// message : "User social profile updated successfully"
/// result : {"acknowledged":true,"modifiedCount":1,"upsertedId":null,"upsertedCount":0,"matchedCount":1}

class TivraHealthSocialProfileResponse {
  TivraHealthSocialProfileResponse({
      this.message, 
      this.result,});

  TivraHealthSocialProfileResponse.fromJson(dynamic json) {
